...
class IntegrationTests(unittest.TestCase):
    ...
    def test_functions_and_constants(self):
        ...
        self.assertEqual(sin(pi/2)*1116, calculation.calculate("sin(pi/2)1116"))
    ...
    def test_comparison_operators(self):
        ...
        self.assertEqual(1 + 2 * 4 // 3 + 1 != 1 + 2 * 4 // 3 + 2, calculation.calculate("1+24/3+1!=1+24/3+2"))
    ...
    def test_common_tests(self):
        ...
        self.assertEqual((2.0**(pi/pi+e/e+2.0**0.0))**(1.0/3.0),
                         calculation.calculate("(2.0**(pi/pi+e/e+2.0**0.0))**(1.0/3.0)"))
        self.assertEqual(sin(pi/2**1) + log(1*4+2**2+1, 3**2),
                         calculation.calculate("sin(pi/2**1) + log(1*4+2**2+1, 3**2)"))

        self.assertEqual(10*e**0.*log10(.4* -5/ -0.1-10) - -abs(-53//10) + -5,
                         calculation.calculate("10*e^0*log10(.4* -5/ -0.1-10) - -abs(-53//10) + -5"))
        ...
        self.assertEqual(sin(e**log(e**e**sin(23.0),45.0) + cos(3.0+log10(e**-e))),
                         calculation.calculate("sin(e**log(e**e**sin(23.0),45.0) + cos(3.0+log10(e**-e)))"))
